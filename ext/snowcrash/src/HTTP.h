...
#define HTTP_REQUEST_METHOD                                                                                            \
    "(GET|POST|PUT|DELETE|OPTIONS|PATCH|PROPFIND|PROPPATCH|MKCOL|COPY|MOVE|LOCK|UNLOCK|HEAD|LINK|UNLINK|CONNECT|VERSION-CONTROL|REPORT|CHECKOUT|CHECKIN|UNCHECKOUT|MKWORKSPACE|UPDATE|LABEL|MERGE|BASELINE-CONTROL|MKACTIVITY|SEARCH|MKCALENDAR|ACL)"
